          ...
          <div className="card flex-shrink-0 max-w-sm shadow-2xl bg-gray-300  ">
            ...
            <h1 className="text-3xl text-center font-bold text-orange-500">Sign Up</h1>
             ...
             <div className="form-control">
                ...
                <input type="text" {...register("name")}  name="name" placeholder="name" className="input input-bordered text-black" />
              </div>
              <div className="form-control">
                <label className="label">
                  <span className="label-text text-black">Photo_URL</span>
                </label>
                <input type="text" {...register("photoURL")} name="photoURL" placeholder="url" className="input input-bordered text-black" />
              </div>
              <div className="form-control">
                <label className="label">
                  <span className="label-text text-black">Email</span>
                </label>
                <input type="email"  {...register("email",{required:true})}  name="email" placeholder="enter email" className="input input-bordered text-black" />
              ...
              <div className="form-control">
                ...
                <input type="password" {...register("confirmPassword")} name="password" placeholder="password" className="input input-bordered text-black" />
                <label className="label">
              ...
              <div className="form-control mt-6">
                <input className="btn bg-black text-orange-500" type='submit' value="Sign Up" />
                
              </div>
              
             </form>
             <p className='my-4 text-center text-black'>Already Have an Account ? : <Link  className="text-orange-500 font-bold" to="/login">Login</Link></p>
            </div>
          </div>
        </div>

        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div >
                        ...
                        <input className="p-2  w-full text-black bg  " defaultValue="" placeholder="Create your own task   ..."
                            {...register("title")} />
                    </div>
             ...
             <input className="p-3  w-full border border-primary-focus 
                         rounded-3xl" placeholder="#email" defaultValue={user?.email}
             ...
             <input className="p-3  w-full border border-primary-focus  
                    ...
                    <div>
                        ...
                        <input className="p-3 w-full border border-primary-focus  rounded-3xl" type="date" 
                            {...register("date")} />
                    </div>
                  </div>
                  ...
                  <h5 className=" text-2xl mt-3 ps-3 mb-3 font-black"> Description </h5>
                    ...
                    <div className="text-left m-1">
                        ...
                        <input className=" w-full items-start pb-48 border border-primary-focus   p-4 rounded-lg placeholder:" defaultValue="" placeholder="Write here . . ." {...register("description")} />
                    </div>
                    <div>
                    ...
                    <div className="md:grid md:grid-cols-1 lg:grid grid-cols-1 mt-3 p-2">
                        ...
                        <input className="btn  mt-5 bg-orange-500  text-white text-lg  rounded-3xl py-1 lg:ms-72  w-1/2 " type="submit" />
                    </div>
                </form>
            </div>

            ...
            <div className="hero-content  flex-col lg:flex-row ">
                ...
                <div className="card flex-shrink-0 max-w-sm shadow-2xl bg-gray-300 ">
                    <div className="card-body">
                        <h1 className="text-4xl text-center font-bold text-orange-500 ">Login</h1>
                        <form onSubmit={handleSubmit(onSubmit)} >
                            ...
                            <input className="btn bg-black text-orange-500" type='submit' value="Login" />
                               
                            </div>
                            <div className="form-control mt-6">
                                <button onClick={handleGoogleSignIn} className="btn  text-orange-500 bg-black" type='submit' value="Login"><span className="mr-2 bg-white rounded-full p-1"><FcGoogle /></span> Google</button>
                            </div>
                        </form>

                        <p className='my-4 text-center text-black'>New Member ?  ::  <Link className="text-orange-500 font-bold" to="/signUp">Sign Up</Link></p>
